...
!function () {
    ...
    r.prototype = {
        ...
        addData: function (t) {
            ...
            for (var r = -1, i = this.moduleCount - 1, n = 7, o = 0, a = this.moduleCount - 1; 0 < a; a -= 2) for (6 == a && a--; ;) {
        ...
        for (var r = 0, i = 0, n = 0, o = new Array(e.length), a = new Array(e.length), s = 0; s < e.length; s++) {
            ...
            r += h;
            var c = v.getErrorCorrectPolynomial(l), f = new w(o[s], c.getLength() - 1).mod(c);
    ...
    for (var o = {MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8}, s = {
        ...
        getLostPoint: function (t) {
            for (var e = t.getModuleCount(), r = 0, i = 0; i < e; i++) for (var n = 0; n < e; n++) {
                for (var o = 0, a = t.isDark(i, n), s = -1; s <= 1; s++) if (!(i + s < 0 || e <= i + s)) for (var h = -1; h <= 1; h++) n + h < 0 || e <= n + h || 0 == s && 0 == h || a == t.isDark(i + s, n + h) && o++;
                5 < o && (r += 3 + o - 5)
            }
    ...
    var y = (e.prototype.draw = function (t) {
        var e = this._htOption, r = this._el, i = t.getModuleCount();
    ...
    var E = "svg" === document.documentElement.tagName.toLowerCase() ? y : "undefined" == typeof CanvasRenderingContext2D ? (L.prototype.draw = function (t) {
        ...
        if (this._android && this._android <= 2.1) {
            ...
            CanvasRenderingContext2D.prototype.drawImage = function (t, e, r, i, n, o, a, s, h) {
                if ("nodeName" in t && /img/i.test(t.nodeName)) for (var l = arguments.length - 1; 1 <= l; l--) arguments[l] = arguments[l] * u; else void 0 === s && (e *= u, r *= u, i *= u, n *= u);
...
}(), "undefined" != typeof module && (module.exports = QRCode), function (r, o, a) {
    var i, n, s, h = Array.prototype.indexOf, l = Object.assign, u = /MicroMessenger/i.test(navigator.userAgent),
        c = o.documentElement.clientWidth <= 768, t = (o.images[0] || 0).src || "",
        e = v("site") || v("Site") || o.title, f = v("title") || v("Title") || o.title,
        d = v("description") || v("Description") || "", g = {
            url: location.href,
    ...
    r.socialShare = function (t, e) {
        (t = "string" == typeof t ? m(t) : t).length === a && (t = [t]), C(t, function (t) {
            t.initialized || function (t, e) {
                ...
                })(t, "share-component social-share"), function (i, n) {
                    var t = function (t) {
                        t.mobileSites.length || (t.mobileSites = t.sites);
                        var e = (c ? t.mobileSites : t.sites).slice(0), r = t.disabled;
